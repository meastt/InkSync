...
const TattooGeneratorScreen: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (result.success) {
        Alert.alert('Success', 'AI Generator feature coming soon!');
      } else {
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          Create unique tattoo designs using artificial intelligence
        </Text>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <Text style={[styles.infoText, { color: theme.colors.textSecondary }]}>
            1. Describe your ideal tattoo{'\n'}
            2. Choose style and preferences{'\n'}
            3. AI generates unique designs
          </Text>
        </View>
      </View>
    </SafeAreaView>
